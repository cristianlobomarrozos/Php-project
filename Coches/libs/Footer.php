...
<footer class="section footer-classic context-dark bg-image" style="background: #333;">
          ...
          <div class="row row-30">
            <div class="col-md-4 col-xl-5">
              <div class="pr-xl-4"><a class="brand" href="index.html"><img class="brand-logo-light" src="images/agency/logo-inverse-140x37.png" alt="" width="140" height="37" srcset="images/agency/logo-retina-inverse-280x74.png 2x"></a>
                ...
                <!-- Rights-->
                <p class="rights text-white"><span>©  </span><span class="copyright-year">2018</span><span> </span><span>Waves</span><span>. </span><span>All Rights Reserved.</span></p>
              </div>
            </div>
            ...
            <div class="col-md-4 col-xl-3 text-white">
              <h5>Links</h5>
              <ul class="nav-list">
